...
public final class FailureText {
    ...
    public static String describe(Throwable failure) {
        ...
        return switch (message) {
            case "MP4 오디오 트랙 판별 실패" -> "오디오 트랙 유무를 확인하지 못해 저장하지 않았습니다. 다시 시도하세요.";
            ...
            case "audience-restricted" -> "Instagram이 이 게시물의 접근 대상을 제한했습니다. 앱은 로그인 정보 없이 조회하므로 가져올 수 없습니다.";
            case "rate-limited" -> "게시물 요청 한도에 도달했습니다. 잠시 후 재시도하세요.";
