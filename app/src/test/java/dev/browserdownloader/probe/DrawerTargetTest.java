...
public class DrawerTargetTest {
    @Test public void onlyExactTargetPackagesCanShowTheirDrawer() {
        assertEquals(DrawerTarget.CHROME, DrawerTarget.select(DrawerTarget.CHROME, true, true, false));
        assertEquals("", DrawerTarget.select(DrawerTarget.CHROME, true, false, false));
        assertEquals("", DrawerTarget.select(DrawerTarget.X, true, false, false));
        assertEquals("", DrawerTarget.select(DrawerTarget.X, true, true, false));
